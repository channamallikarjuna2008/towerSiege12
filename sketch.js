...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("red", "red");
  box2.display("red", "red");
  box3.display("red", "red");
  box4.display("red", "red");
  box5.display("red", "red");
  box6.display("indigo", "red");
  box7.display("indigo", "red");
  box8.display("indigo", "red");
  box9.display("indigo", "red");
  box10.display("green", "red");
  box11.display("green", "red");
  box12.display("green", "red");
  box13.display("orange", "red");
  box14.display("orange", "red");
  box15.display("blue", "red");
